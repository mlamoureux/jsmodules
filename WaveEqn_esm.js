/**
 * Copyright 2018, 2020, 2023 - M. Lamoureux 
 * Adapted to use for esm style exports
 */
export function WaveEngine(gpgpUtility_, xResolution_, yResolution_, xLength_, yLength_, dt_)
{
  "use strict";
